...
class CachedConfig(DefaultConfig):
    ...
    def __init__(self, redis_host: str, redis_port: int, redis_db: int = 0, redis_pass: Optional[str] = None, **kwargs) -> None:
    ...
    def redis_ttl(self, ttl_value: Optional[int]) -> None:
        if ttl_value and ttl_value > 0:
            ...
            self.logger.debug(f'redis_ttl: 0, negative or None TTL value: {ttl_value}, set to None')
